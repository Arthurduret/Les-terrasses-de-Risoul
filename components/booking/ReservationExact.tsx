...
.ltr-facts{display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center;gap:14px 24px;margin-top:34px;padding-top:30px;border-top:1px solid rgba(237,231,223,.12);font-size:15px;color:#B7AFA4}
@media(min-width:640px){.ltr-facts{flex-wrap:nowrap;gap:12px;white-space:nowrap}}
